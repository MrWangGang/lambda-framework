...
public enum ExceptionEnum {
    ...
    EAI0000002("EI00000002","uniqueId不能为空"),
    EAI0000003("EI00000003","缺少模型参数"),
    EAI0000009("EAI0000009","uniqueId无效"),
    EAI0000004("EI00000004","openAiApiKey不能为空"),
    EAI0000005("EI00000005","userId不能为空"),

    EAI00000006("EAI00000006","Ai-Api错误"),
    ...
    EAI00000100("EAI00000100","当前配额少于此次会话所需的token"),
    EAI00000101("EAI00000101","当前会话超过了该服务的最大配额"),

    EAI00000102("EAI00000102","当前会话超过了该服务的最大配额,可以选择重新开始新一轮对话"),
    EAI00000103("EAI00000103","不支持的模型");
