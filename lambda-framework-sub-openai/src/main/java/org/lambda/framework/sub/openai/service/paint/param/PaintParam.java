package org.lambda.framework.sub.openai.service.paint.param;
...
@Getter
@Setter
public class PaintParam extends LambOpenAiParam {
    ...
    @Builder
    public PaintParam(Integer n, String prompt, Long quota, Integer maxTokens, Long timeOut, String openAiApiKey, String userId, LambOpenAiUniqueParam lambOpenAiUniqueParam, String size, String responseFormat, String user) {
