...
public class ChatParam extends AbstractParam {
    ...
    @Builder
    public ChatParam(Integer n, String prompt, Long quota, Integer maxTokens, Long timeOut, String openAiApiKey, String userId, UniqueParam uniqueParam, String persona, Double temperature, Double topP, Boolean stream, Double presencePenalty, Double frequencyPenalty) {
