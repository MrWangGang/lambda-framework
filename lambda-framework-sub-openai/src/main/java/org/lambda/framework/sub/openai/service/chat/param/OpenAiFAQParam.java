...
@Getter
@Setter
public class OpenAiFAQParam extends OpenAiAbstractParam {
    //AI人设
    ...
    @Builder
    public OpenAiFAQParam(Integer n, String prompt, Long quota, Integer maxTokens, Long timeOut, String apiKey, String userId, OpenAiUniqueParam uniqueParam, String persona, Double temperature, Double topP, Boolean stream, Double presencePenalty, Double frequencyPenalty) {
