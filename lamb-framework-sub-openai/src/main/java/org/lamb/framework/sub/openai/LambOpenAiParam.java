...
public class LambOpenAiParam {
    public void verify(){
        ...
        if(lambOpenAiUniqueParam == null)throw new LambEventException(EAI0000002);
        if(StringUtils.isBlank(lambOpenAiUniqueParam.getUniqueId()))throw new LambEventException(EAI0000002);
        if(StringUtils.isBlank(lambOpenAiUniqueParam.getUniqueTime()))throw new LambEventException(EAI0000009);
        ...
        if(!LambOpenAiContract.verify(userId,lambOpenAiUniqueParam))throw new LambEventException(EAI00000008);
        //配额校验
    ...
    public LambOpenAiParam(Integer n, String prompt, Long quota, Integer maxTokens, Long timeOut, String openAiApiKey, String userId, LambOpenAiUniqueParam lambOpenAiUniqueParam) {
        this.n = n;
        this.prompt = prompt;
        this.quota = quota;
