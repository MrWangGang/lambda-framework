...
import org.lambda.framework.lock.ReactiveRedissonLockBuilder;
...
public abstract class AbstractReactiveRedissonConfig {
    ...
    protected ReactiveRedissonLockBuilder buildSingleClient(){
        //密码不需要校验
        ...
        return new ReactiveRedissonLockBuilder(redisson.reactive());
    }
}
